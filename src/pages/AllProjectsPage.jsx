    ...
    <body className="flex min-h-screen justify-center items-center">
      <div className="pt-24 mt-24">
        <div>
          ...
          <p className="font-bold text-center text-lg text-indigo-500 pb-5"><Link className="text-indigo-800" to="/registration">SIGN UP NOW</Link> to create your campaign or to donate. Now it's time to future proof yourself and your peers! 🚀</p>
        </div>
