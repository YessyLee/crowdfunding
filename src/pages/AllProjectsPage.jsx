  ...
  return (
    ...
    <div className="pt-24 mt-24">
      <section className="">
        ...
        <p className="font-bold text-center text-lg text-indigo-500 pb-5"><Link className="text-indigo-800" to="/registration">SIGN UP </Link> now to start a campaign or to donate. Now it's time to future proof yourself and your peers! 🚀</p>
      </section>
